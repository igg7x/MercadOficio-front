...
import JobsActiveUserOffering from "./components/JobsActiveUserOffering";
import JobsHistorialUserOffering from "./components/JobsHistorialUserOffering";
const JobMain = () => {
  const TABS = ["Trabajos activos", "Historial de aplicaciones"];
    ...
    <>
      <section className="[grid-area:main] flex-col flex items-center overflow-y-auto bg-gray-50">
        ...
        <div className="flex flex-col mx-auto px-4 items-center">
          ...
          {selectedTab === TABS[0] ? (
            <JobsActiveUserOffering />
          ) : (
            <JobsHistorialUserOffering />
          )}
        </div>
      </section>
    </>
